...
from IRCNN_sigmamap_denoise import psnr_torch, ssim_torch, list_images
...
deblur_ircnn_vf(clean_path=clean_path)'''
...
'''test_deblurring_with_levin09(
    ...
    n_iter=8,
    lam=0.23,
    out_dir="./results_IRCNN_sigmamap/deblur_single",
 )'''
...
def run_deblur_one_return_metrics(
    ...
    out_dir: str = "./results_IRCNN_sigmamap/deblur_benchmark",
):
    if save_outputs:
        os.makedirs(out_dir, exist_ok=True)

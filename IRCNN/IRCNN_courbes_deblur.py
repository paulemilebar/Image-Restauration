...
from IRCNN_deblur import load_levin09_kernel, psf_to_otf, circ_conv_fft
...
def plot_convergence_curves(logs, title="Convergence Deblur IRCNN", save_dir ="results_IRCNN/deblur_courbes"):
    ks = np.array(logs["k"])
